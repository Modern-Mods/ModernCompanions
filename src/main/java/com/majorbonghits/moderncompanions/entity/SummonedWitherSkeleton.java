...
public class SummonedWitherSkeleton extends WitherSkeleton {
    ...
    public void tick() {
        ...
        if (this.tickCount % 20 == 0) {
            ...
            if (owner != null) {
                ...
                if (ownersTarget != null && this.canAttack(ownersTarget)) {
                    ...
                    if (nearby != null) this.setTarget(nearby);
                }
            }
        }
        ...
        if (owner != null) {
            ...
            double followRange = 28.0D;
            double hardRange = 52.0D;
            if (dist > followRange * followRange) this.getNavigation().moveTo(owner, 1.25D);
            if (dist > hardRange * hardRange) this.teleportTo(owner.getX(), owner.getY(), owner.getZ());
        }
    }
